...
use T4s\CamelotAuth\Throteller\ThrotteleProviderInterface;
// exceptions
use T4s\CamelotAuth\Auth\Local\Exceptions\LoginRequiredException;
...
class LocalAuth extends AbstractAuth{
	...
	*
	* @var T4s\CamelotAuth\Throteller\ThrotteleProviderInterface
	*/
